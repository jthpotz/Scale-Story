...
public partial class ScaleInventory : Control {
    ...
    public override void _Ready () {
        ...
        defs[ScaleColor.Blue] = "(noun) - Botany. Also called bud scale. a rudimentary body, usually a specialized leaf and often covered with hair, wax, or resin, enclosing an immature leaf bud.";
        defs[ScaleColor.Purple] = "(verb) - to climb; ascend; mount.";
